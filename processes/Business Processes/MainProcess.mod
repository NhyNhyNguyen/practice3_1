...
Ms0 f3 dialogId Practice31.HomePage #txt
Ms0 f3 startMethod start(Practice31.MainProcessData) #txt
Ms0 f3 requestActionDecl '<Practice31.MainProcessData mainProcessData> param;' #txt
Ms0 f3 requestMappingAction 'param.mainProcessData=in;
' #txt
