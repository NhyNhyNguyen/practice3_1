...
Hs0 f0 guid 18707052D9FC70D4 #txt
Hs0 f0 method start(Practice31.MainProcessData) #txt
Hs0 f0 inParameterDecl '<Practice31.MainProcessData mainProcessData> param;' #txt
Hs0 f0 inParameterMapAction 'out.mainProcessData=param.mainProcessData;
' #txt
Hs0 f0 outParameterDecl '<Practice31.MainProcessData mainProcessData> result;' #txt
Hs0 f0 outParameterMapAction 'result.mainProcessData=in.mainProcessData;
' #txt
...
>Proto Hs0 .type Practice31.HomePage.HomePageData #txt
